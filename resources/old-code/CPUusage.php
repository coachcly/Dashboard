...
//	Program Name:		CPUusage.php 
//	Program Title:		CPU Usage
...
function getusage()
{
	...
	while ($row = db2_fetch_assoc($stmt))
	{
		...
		if ($cpu[$temp] <= 50) 
			$graph[$temp] = 
		"<img src='images/line_green.GIF' title='$cpu[$temp]%' width='$cpu[$temp]%' height=8> $cpu[$temp]%";
		
		if ($cpu[$temp] > 50 && $cpu[$temp] <= 75) 
			$graph[$temp] = 
		"<img src='images/line_green.GIF' title='$cpu[$temp]%' width='50%' height=8>".
		"<img src='images/line_blue.GIF' title='$cpu[$temp]%' width='".($cpu[$temp]-50)."%' height=8> $cpu[$temp]%";
		
		if ($cpu[$temp] > 75) 
			$graph[$temp] = 
		"<img src='images/line_green.GIF' title='$cpu[$temp]%' width='50%' height=8>".
		"<img src='images/line_blue.GIF' title='$cpu[$temp]%' width='25%' height=8>".
		"<img src='images/line_red.GIF' title='$cpu[$temp]%' width='".($cpu[$temp]-75)."%' height=8> $cpu[$temp]%";
...
function ClickArrow(valuein) {
  ...
  <body background="images/back_grey.jpg">
    ...
    <div id="pagetitle" class="pagetitle">System Performance</div>
...
<center>    
  ...
  <tr valign="middle">
    ...
    <th width="30%" nowrap="nowrap" scope="col"><input type="submit" name="button" id="button" value="Refresh Page" /></th>
  </tr>
  </form>  
</table>
...
<table width="64%" border="1" id="listtable"  class="mainlist" cellpadding="1" cellspacing="0">
<tr>
    ...
    <th width="79%" valign="middle" nowrap="nowrap" scope="col"><div align="left"> System Performance (CPU Usage in 15min Intervals)</div></th>
      ...
      <tr>
        <td nowrap="nowrap" bgcolor="#FFFFFF"><div align="center">12:01 - 1:00am</div></td>
      ...
      <tr>
        <td nowrap="nowrap" bgcolor="#FFFFFF"><div align="center">1:01 - 2:00am</div></td>
      ...
      <tr>
        <td nowrap="nowrap" bgcolor="#FFFFFF"><div align="center">2:01 - 3:00am</div></td>
      ...
      <tr>
        <td nowrap="nowrap" bgcolor="#FFFFFF"><div align="center">3:01 - 4:00am</div></td>
      ...
      <tr>
        <td nowrap="nowrap" bgcolor="#FFFFFF"><div align="center">4:01 - 5:00am</div></td>
      ...
      <tr>
        <td nowrap="nowrap" bgcolor="#FFFFFF"><div align="center">5:01 - 6:00am</div></td>
      ...
      <tr>
        <td nowrap="nowrap" bgcolor="#FFFFFF"><div align="center">6:01 - 7:00am</div></td>
      ...
      <tr>
        <td nowrap="nowrap" bgcolor="#FFFFFF"><div align="center">7:01 - 8:00am</div></td>
      ...
      <tr>
        <td nowrap="nowrap" bgcolor="#FFFFFF"><div align="center">8:01 - 9:00am</div></td>
      ...
      <tr>
        <td nowrap="nowrap" bgcolor="#FFFFFF"><div align="center">9:01 - 10:00am</div></td>
      ...
      <tr>
        <td nowrap="nowrap" bgcolor="#FFFFFF"><div align="center">10:01 - 11:00am</div></td>
      ...
      <tr>
        <td nowrap="nowrap" bgcolor="#FFFFFF"><div align="center">11:01 - 12:00pm</div></td>
      ...
      <tr>
        <td nowrap="nowrap" bgcolor="#FFFFFF"><div align="center">12:01 - 1:00pm</div></td>
      ...
      <tr>
        <td nowrap="nowrap" bgcolor="#FFFFFF"><div align="center">1:01 - 2:00pm</div></td>
      ...
      <tr>
        <td nowrap="nowrap" bgcolor="#FFFFFF"><div align="center">2:01 - 3:00pm</div></td>
      ...
      <tr>
        <td nowrap="nowrap" bgcolor="#FFFFFF"><div align="center">3:01 - 4:00pm</div></td>
      ...
      <tr>
        <td nowrap="nowrap" bgcolor="#FFFFFF"><div align="center">
      ...
      <tr>
        <td nowrap="nowrap" bgcolor="#FFFFFF"><div align="center">8:01 - 9:00pm</div></td>
...
function internal_init()
{
    ...
    // Last Generated CRC: 35ADC9ED 3040B85C 6921C629 926D3E47
    // Path: C:\Program Files\ESDI\WebSmart\temp\Dashboard_www_websmart_htdocs_dashboard_PHW Filels_CPUusage.phw
}
?>