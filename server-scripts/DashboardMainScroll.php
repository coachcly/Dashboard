...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="styles/jquery.tablescroll.css"> 
 ...
 include('Includes/menu.php'); 
    ...
    <form name="form1" method="post" action="">
      ...
      <div id="contents">
        ...
        <table width="98%" id="listtable" class="mainlist">
        <thead>
          <tr bgcolor="#8CA9CF">
            <td width="135" title="Click to Sort" onClick="form1.sort.value = &quot;SYSTEM&quot;;
              return Submit();" onMouseOver="mover(this);" onMouseOut="mout(this);">System<br>
              Description</td>
            <td width="70"  title="Click to Sort" onClick="form1.sort.value = &quot;METHOD&quot;;
              return Submit();" onMouseOver="mover(this);" onMouseOut="mout(this);">CHKSYS<br>
              Method</td>
            <td width="200" title="Click to Sort" onClick="form1.sort.value = &quot;CHKSYSDATE, CHKSYSTIME&quot;;
              return Submit();" onMouseOver="mover(this);" onMouseOut="mout(this);">CHKSYS<br>
              (Date Time Zone)<br>(CCYY/MM/DD&nbsp;&nbsp;HH:MM:SS)</td>
            <!--<td width="88">Serial<br>
          Number<br>(QSRLNBR)</td>-->
            <td width="80" title="Click to Sort" onClick="form1.sort.value = &quot;QMODEL&quot;;
              return Submit();" onMouseOver="mover(this);" onMouseOut="mout(this);">Model<br>
              (QMODEL)</td>
            <!--<td width="96">Processor<br>
          Feature<br>(QPRCFEAT)</td>-->
            <td width="100" title="Click to Sort" onClick="form1.sort.value = &quot;PRCGRP&quot;;
              return Submit();" onMouseOver="mover(this);" onMouseOut="mout(this);">Processor<br>
              Group</td>
            <td width="111" title="Click to Sort" onClick="form1.sort.value = &quot;CONSOLETYP&quot;;
              return Submit();" onMouseOver="mover(this);" onMouseOut="mout(this);">Console<br>
              Type</td>
            <td width="102" title="Click to Sort" onClick="form1.sort.value = &quot;KEYLCKPOS&quot;;
              return Submit();" onMouseOver="mover(this);" onMouseOut="mout(this);">Keylock<br>
              Position</td>
            <td width="72" title="Click to Sort" onClick="form1.sort.value = &quot;OSRLS&quot;;
              return Submit();" onMouseOver="mover(this);" onMouseOut="mout(this);">OS<br>
              Release</td>
            <td width="107" title="Click to Sort" onClick="form1.sort.value = &quot;CUMPTFPKG&quot;;
              return Submit();" onMouseOver="mover(this);" onMouseOut="mout(this);">Cumulative<br>
              PTF<br>Package</td>
            <td width="67" title="Click to Sort" onClick="form1.sort.value = &quot;TOTASP&quot;;
              return Submit();" onMouseOver="mover(this);" onMouseOut="mout(this);">Total<br>
              ASP</td>
            <td width="77" title="Click to Sort" onClick="form1.sort.value = &quot;ASPUSED&quot;;
              return Submit();" onMouseOver="mover(this);" onMouseOut="mout(this);">ASP<br>
              Used</td>
            <td width="100" title="Click to Sort" onClick="form1.sort.value = &quot;DSKSTSERR&quot;;
              return Submit();" onMouseOver="mover(this);" onMouseOut="mout(this);">WRKDSKSTS<br>
              Errors</td>
            <td width="100" title="Click to Sort" onClick="form1.sort.value = &quot;WRKPRBERR&quot;;
              return Submit();" onMouseOver="mover(this);" onMouseOut="mout(this);">WRKPRB<br>
              Errors</td>
            <td width="100" title="Click to Sort" onClick="form1.sort.value = &quot;QSYSMSGERR&quot;;
              return Submit();" onMouseOver="mover(this);" onMouseOut="mout(this);">QSYSMSG<br>
              Critical<br>Errors</td>
            <td width="70" title="Click to Sort" onClick="form1.sort.value = &quot;BATSTS&quot;;
              return Submit();" onMouseOver="mover(this);" onMouseOut="mout(this);">Cache<br>
              Battery<br>Status</td>
            <td width="135" title="Click to Sort" onClick="form1.sort.value = &quot;CHKSYSKEY&quot;;
              return Submit();" onMouseOver="mover(this);" onMouseOut="mout(this);">Reference Key<br>
            <br>System Performance</td>
          </tr>
         </thead>
         <tbody>
SEGDTA;
...
<tr class="
SEGDTA;
 if ($first == null) echo "first $pf_altrowclr"; else echo "$pf_altrowclr"; $first = 1; 
		echo <<<SEGDTA
" id="$x" onmouseover="TRmover(this);" onmouseout="TRmout(this);">
...
<script type="text/javascript" src="javascript/jquery.tablescroll.js"></script>
...
$(".tablescroll_wrapper").height(h);
	...
	$('#listtable').tableScroll({height:h});
...
<tr class="$pf_altrowclr" id="$x" onmouseover="TRmover(this);" onmouseout="TRmout(this);">
  ...
  <td nowrap="nowrap" bgcolor="$MXAUDERR_color" class="text" onClick="loadwindow('DSPMXAUD.php?CHKSYSKEY=$CHKSYSKEY&amp;BG=$MXAUDERR_color',650,500)"><div align="center" onmouseover="mover(this);"  onmouseout="mout(this);">
  $MXAUDERR</div></td>
...
$pf_liblLibs[1] = 'DASHBOARD';
    ...
    // Last Generated CRC: 974C047F 5DA02756 4589281D 646FE1EF
